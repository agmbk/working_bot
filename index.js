...
try {
	...
	console.log( '*** Database data ***'.blue(), data, new Date(new Date().toJSON()).toUTCString(), new Date(getLocaleDate().toJSON()).toUTCString(), getLocaleDate(getLocaleDate().toJSON()).toUTCString() );
