...
try {
	...
	console.log( '*** Database data ***'.blue(), data, new Date(new Date().toJSON()).toUTCString(), new Date(new Date('Sun Aug 28 2022 00:45:39 GMT+0000'.split('GMT')[0]).toJSON()).toUTCString() );
